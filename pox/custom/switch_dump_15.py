...
class Simple15Switch(Topo):
    ...
    def __init__(self, **opts):
        ...
        super(Simple15Switch, self).__init__(**opts)
        ...
        s0 = self.addSwitch('s0', dpid="1000000000000000", 
            protocols='OpenFlow15', datapath='system')
        s1 = self.addSwitch('s1', dpid="0100000000000000", 
            protocols='OpenFlow15', datapath='system')
        s2 = self.addSwitch('s2', dpid="0010000000000000", 
            protocols='OpenFlow15', datapath='system')
...
def run():
    ...
    net = Mininet(topo=Simple15Switch(), host=CPULimitedHost, controller=None, switch=OVSSwitch)
    net.addController(c)
    net.start()
...
topos = { 'simple_15_switch' : ( lambda: Simple15Switch())}
